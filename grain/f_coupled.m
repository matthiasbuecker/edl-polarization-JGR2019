function f = f_coupled(omega,c0,mu,muS,e_m,e_p,a,zeta,SigmaS,T)
% F_COUPLED computes the frequency-dependent reflection coefficient for the
% superposed Stern-layer, diffuse-layer, Maxwell-Wagner polarization process.
% The response is a superposition of the Lyklema et al. (1983) and the 
% Dukhin-Shilov (1974) responses.
%
...
% 2. Stern-layer polarization according to Lyklema et al. (1983)
% % Dimensionless coefficient M [eq. (34)]
M = 1+ kappa*SigmaS./(2*F*c0*cosh(zeta/(2*kB*T)));
